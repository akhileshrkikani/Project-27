...
bobObject2=new Bob(300,600,20,20);
bobObject3=new Bob(400,600,20,20);
bobObject4=new Bob(500,600,20,20);
bobObject5=new Bob(600,600,20,20);
roof1=new Roof(400,151,600,50);
...
function keyPressed(){
	if(keyCode === UP_ARROW){
    Matter.Body.applyForce(bobObject1.body,bobObject1.body.position, {x:-320,y:305});
  }
}
